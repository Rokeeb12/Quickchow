...
if($tob<=$tot){
     ...
     $submit = mysqli_query($con,"insert into dat(num,poz,stat,status,quantity,cod) values ('$kol','$kat','$cob','$baz','0','$cok')") or die ('Could not connect: ' .mysqli_error($con));
...
header("location:order6.php");
      ...
      echo '<script>alert("You cannot add more than 4 extra plate");window.location.href = "order6.php";</script>';
}
