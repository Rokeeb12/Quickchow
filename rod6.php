...
if (!empty($_POST['nub'])) {
    ...
    $stmtStatus->bind_param("si", $deal, $fo);
    $stmtStatus->execute();
 ...
 $status2='pending';
   $stmtInsert = $con->prepare("
    ...
    LIMIT 1");
$stmt2->bind_param("ssss", $status, $deal,$name,$fo);
$stmt2->execute();
$stmt2->close();
